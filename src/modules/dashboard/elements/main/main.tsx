...
import DashboardOverViewCard from '@/shared/components/card/overview-card'
import SubscribersChart from '@/shared/components/charts/subscribers-charts'
...
const Main = () => {
  ...
  return (
    <div className="p-5 w-full bg-[#fafafb]">
      ...
      <div className="w-full flex ">
        <div className="w-[75%] min-h-[88vh] pr-5">
          <br />
        ...
        <div className="w-[35%] p-5">
              ...
              <div>
                ...
                >
                  ...
                  <div className="absolute h-[38px] w-[90px] rounded-r-lg bg-[#DFE7FF] right-0 flex items-center justify-center">
                    ...
                    <span className="pl-1 text-sm">copy</span>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="w-full bg-white border rounded p-5 my-3">
            ...
            <p className="text-sm opacity-[.7]">
              Learn how to get started on postpal and utilize all our features,
              directly from the postpal team.
            </p>
            <br />
