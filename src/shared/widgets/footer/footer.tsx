      ...
      <div className="w-[95%] md:flex m-auto py-5">
        <div className="w-full md:w-[40%]">
          ...
          <p className="text-2xl py-2">
            Get postpal updates directly to your inbox
          </p>
          ...
          <br />
          <p className="text-xs">
            By subscribing you agree with our privac, policy and provide consent
          ...
          <div className="md:w-[50%] flex justify-around">
            ...
            <div>
              <ul>
                ...
                <li className="text-xl pb-4 cursor-pointer">Prcing </li>
